...
public class List extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        background3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assignment2/1.jpg"))); // NOI18N
    ...
    private void treadActionPerformed(java.awt.event.ActionEvent evt) {                                      
        this.setVisible(false);
        Treadmill info = new Treadmill();
        info.setVisible(true);
    }                                     

    private void barActionPerformed(java.awt.event.ActionEvent evt) {                                    
        this.setVisible(false);
        Barbells info = new Barbells();
        info.setVisible(true);
    }                                   

    private void dumbActionPerformed(java.awt.event.ActionEvent evt) {                                     
        this.setVisible(false);
        Dumbbells info = new Dumbbells();
        info.setVisible(true);
    }                                    

    private void inclineActionPerformed(java.awt.event.ActionEvent evt) {                                        
        this.setVisible(false);
        Incline info = new Incline ();
        info.setVisible(true);
    }                                       

    private void stationActionPerformed(java.awt.event.ActionEvent evt) {                                        
        this.setVisible(false);
        Bike info = new Bike ();
        info.setVisible(true);
    }                                       

    private void cataActionPerformed(java.awt.event.ActionEvent evt) {                                     
        this.setVisible(false);
