...
public class Catalogue extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        background9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assignment2/t1.jpg"))); // NOI18N
        jPanel1.add(background9, new org.netbeans.lib.awtextra.AbsoluteConstraints(3, 30, 620, 80));

        ps.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assignment2/y2.jpg"))); // NOI18N
        ...
        pb.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assignment2/y5.jpg"))); // NOI18N
        ...
        pd.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assignment2/y4.jpg"))); // NOI18N
        ...
        pi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assignment2/y3.jpg"))); // NOI18N
        ...
        pt.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assignment2/y1.jpg"))); // NOI18N
    ...
    private void ptMouseClicked(java.awt.event.MouseEvent evt) {                                
        this.setVisible(false);
        Treadmill info = new Treadmill();
        info.setVisible(true);
    }                               

    private void psMouseClicked(java.awt.event.MouseEvent evt) {                                
        this.setVisible(false);
        Bike info = new Bike();
        info.setVisible(true);
    }                               

    private void piMouseClicked(java.awt.event.MouseEvent evt) {                                
        this.setVisible(false);
        Incline info = new Incline();
        info.setVisible(true);
    }                               

    private void pdMouseClicked(java.awt.event.MouseEvent evt) {                                
        this.setVisible(false);
        Dumbbells info = new Dumbbells();
        info.setVisible(true);
    }                               

    private void pbMouseClicked(java.awt.event.MouseEvent evt) {                                
        this.setVisible(false);
        Barbells info = new Barbells();
        info.setVisible(true);
    }                               

    private void atc1ActionPerformed(java.awt.event.ActionEvent evt) {                                     
        this.setVisible(false);
        Cart info = new Cart();
        info.setVisible(true);
    }                                    

    private void atc2ActionPerformed(java.awt.event.ActionEvent evt) {                                     
        this.setVisible(false);
        Cart info = new Cart();
        info.setVisible(true);
    }                                    

    private void atc3ActionPerformed(java.awt.event.ActionEvent evt) {                                     
        this.setVisible(false);
        Cart info = new Cart();
        info.setVisible(true);
    }                                    

    private void atc4ActionPerformed(java.awt.event.ActionEvent evt) {                                     
        this.setVisible(false);
        Cart info = new Cart();
        info.setVisible(true);
    }                                    

    private void atc5ActionPerformed(java.awt.event.ActionEvent evt) {                                     
        this.setVisible(false);
        Cart info = new Cart();
        info.setVisible(true);
    }                                    
